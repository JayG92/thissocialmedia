  ...
  return (
    <div className="text-center">
      <Card className="memberBox memberFloat">
          <div className="text-center">
      <div>{this.state.profilepic.length >= 1 ? <img className="memberImg" id="pImage" src={this.state.profilepic} alt="Profile"></img> : <img className="memberImg" id="pImage" src="https://cdn1.iconfinder.com/data/icons/user-pictures/100/unknown-512.png" alt="Profile"></img>}</div>
